		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" style="font-weight: bold; font-size: 40px; margin-top: 10px;">Log Activity Documents IRS</h3>
					...
					<div class="col-lg-2 text-right">
                    	...
                    	<?php
							if($_REQUEST['keyword']<>""){
                    	?>
                        	<a class="btn btn-default" href="log_document.php" style="height: 32px; border-color: transparent; font-weight: bold;">Reset Search</a>
                    	<?php
                    		}
                    	?>
                	</div>
                	...
                	<div class= "nav navbar-nav navbar-right col-md-3">
                    	<form method="post" action="log_document.php">
