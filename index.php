			...
			<div class="container">
				<div class="row">
					...
					<div class= "nav navbar-nav navbar-right col-md-3">
						...
						<div class="col-sm-6">
							<div class="media">
								<div class="media-body text-left">
									...
									<p style="margin-left: 40px;"><?php echo ++$no_urut;?>. &nbsp; <?php echo '<a target="_blank" style="font-weight: bold;" href = " '.$data['link'].'">'.$data['judul_news'].'</a>';?>
									</p>
						...
						<div style="margin-left: 800px;"><?php echo paginate_one($reload, $page, $tpages);?></div>
					...
					<div class="col-md-12">
						<div class="media testimonial">
							<div class="media-left" style="width: 70px; height: 70px;">
								<a href="https://bantek.telkomku.com/@dds/login.php" target="_blank"><img src="images/tech-supp2.jpg" alt=""></a>
							</div>
