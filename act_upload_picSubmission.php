...
<?php
  ...
  <?php }
    ...
    $url            = $_POST['URL'];
      ...
      if($url != '') {
        $sql2 = "INSERT INTO upload_dtp (ID_UPLOAD, USERNAME, TGL_UPLOAD, JUDUL_UPLOAD, JENIS_FILE_UPLOAD, UNGGULAN, JENIS_LAB_UPLOAD, DESKRIPSI_UPLOAD, NAMA_FILE_UPLOAD, URL) VALUES (null, '$username', NOW(), '$judul', '$jenis_file', '$unggulan', '$jenis_lab', '$deskripsi', '$nama_file', '$url')";
